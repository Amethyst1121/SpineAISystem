...
class SegmentationTest(object):
    ...
    def get_transformed_image(self, prediction_np, reference_sitk=None, output_spacing=None, transformation=None):
        ...
        if transformation is not None:
            ...
            prediction_np = sitk_np.sitk_list_to_np(predictions_sitk, axis=0)
        else:
            if self.channel_axis != 0:
                prediction_np = np_image.split_by_axis(prediction_np, self.channel_axis)
    ...
    def get_prediction_labels_list(self, prediction):
        ...
        prediction_labels = np_image.argmax(prediction, axis=0)
        return np_image.split_label_image(prediction_labels, list(range(num_labels)))
    ...
    def filter_largest_connected_component(self, prediction):
        ...
        while True:
            ...
            prediction_labels_largest_cc_list = [np_image.largest_connected_component(prediction_labels)
    ...
    def filter_all_labels_are_connected(self, prediction):
        ...
        all_labels_prediction = np_image.argmax(prediction_background_others, axis=0)
        # get largest component of other labels
        all_labels_prediction = np_image.largest_connected_component(all_labels_prediction)
    ...
    def get_label_image(self, prediction_np, reference_sitk=None, output_spacing=None, transformation=None, return_transformed_sitk=False, image_type=None):
        ...
        prediction_labels_sitk = sitk_np.np_to_sitk(prediction_labels, type=image_type)
