...
from ..utils.landmark import transform
from ..transformations.spatial.common import flipped_dimensions
import functools
import copy
from .transformation_generator_base import TransformationGeneratorBase
...
class LandmarkGeneratorBase(TransformationGeneratorBase):
    ...
    def is_flipped(self, transformation, output_size):
        ...
        """
        flipped = flipped_dimensions(transformation, output_size)
    ...
    def transform_landmarks(self, landmarks, transformation, output_size, output_spacing):
        ...
        """
        return transform.transform_landmarks_inverse(landmarks, transformation, output_size, output_spacing, self.min_max_transformation_distance)
...
class LandmarkGeneratorHeatmap(LandmarkGeneratorBase):
    ...
    def get(self, landmarks, transformation, **kwargs):
        ...
        # print("Generated heatmap shape:", heatmaps.shape)
        return heatmaps
